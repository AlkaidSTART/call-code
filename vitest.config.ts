...
export default defineConfig({
  test: {
    ...
    alias: [
      ...
      { find: '@utils', replacement: path.resolve(__dirname, './packages/agent-core/src/harness/utils') },
      ...
      { find: /^@tools$/, replacement: path.resolve(__dirname, './packages/agent-core/src/harness/session/tools/index.ts') },
      { find: /^@tools\//, replacement: path.resolve(__dirname, './packages/agent-core/src/harness/session/tools') + '/' },
      { find: '@policy', replacement: path.resolve(__dirname, './packages/agent-core/src/harness/session/policy') },
